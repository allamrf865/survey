...
# HEADER INTERAKTIF
st.markdown("<h1 style='text-align: center; color: #FF5733;'>📊 Web-App Analisis Kuesioner</h1>", unsafe_allow_html=True)
...
# FOOTER
st.markdown("<h5 style='text-align: center; color: #888;'>🚀 Dibangun dengan 💙 oleh Lammy miaw tutut 🌍</h5>", unsafe_allow_html=True)
